...
def show_notification(text):
    ...
    label = tk.Label(frame, text=text, font=("Arial", 20), bg='black', fg='white')

    # Center the label text in the frame
    label.pack(pady=(frame.winfo_height() // 2) - (label.winfo_height() // 2))
